...
public class MasterDialogCad extends JInternalFrame {
	...
	private void Componnents() {
		...
		btnSearch = new JButton("Buscar",
				new ImageIcon(System.getProperty("user.dir") + "\\images\\icons\\buscar.png"));
		...
		btnDelete = new JButton("Remover",
				new ImageIcon(System.getProperty("user.dir") + "\\images\\icons\\remover.png"));
		...
		btnCancel = new JButton("Cancelar",
				new ImageIcon(System.getProperty("user.dir") + "\\images\\icons\\cancelar.png"));
